...
{
  ros::init(argc, argv, "stero_planer");
  float distance = 0;
  ...
  ros::Subscriber odomSubscriber = n.subscribe("/mobile_base_controller/odom", 1000, odomCallback);
  ...
  ros::Publisher distancePublisher = n.advertise<std_msgs::String>("stero_tiago_distance_to_goal", 1000);
